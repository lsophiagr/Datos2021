...
CREATE TABLE cooperativa_historial(
...
CREATE TABLE cliente(
    ...
    segundo_nombrre VARCHAR2(50) NOT NULL,
    primer_apellido VARCHAR2(50) NOT NULL,
    segundo_apellido VARCHAR2(50) NOT NULL,
    correo VARCHAR2(50) NOT NULL,
    direccion VARCHAR2(100) NOT NULL,
    numero_telofonico  VARCHAR2(20),
...
CREATE TABLE cuenta(
    ...
    tipo_moneda VARCHAR2(10) CHECK(tipo_moneda=ANY('GTQ','USD')) NOT NULL,
...
CREATE TABLE cuenta_detalle(
    ...
    trans_tipo VARCHAR2(10) CHECK (trans_tipo = ANY('Deposito', 'Retiro')),
...
CREATE TABLE cdp_detalle(
    ...
    monto FLOAT(4) NOT NULL,
    estado VARCHAR2(10) CHECK(estado=ANY('True','False')),
...
CREATE TABLE prestamo_detalle(
    ...
    fecha_pago DATE NOT NULL,
    interes_mensual FLOAT(4) NOT NULL,
...
CREATE TABLE operaciones(
    ...
    id_destino NUMBER,
    trans_tipo VARCHAR2(10) CHECK (trans_tipo = ANY('Deposito', 'Retiro')),
    detalle VARCHAR2(20) CHECK (detalle = ANY('Efectivo', 'Transaccion', 'Pago Prestamo', 'Pago CDP')),
    monto FLOAT(4) NOT NULL,
    ...
    FOREIGN KEY(id_cuenta) REFERENCES cuenta(id_cuenta),
    FOREIGN KEY(id_destino) REFERENCES cuenta(id_cuenta)
);
